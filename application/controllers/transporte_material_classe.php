...
class transporte_material_classe extends App_controller {
    ...
    public function index()
    {
    	...
    	$data['composicoes'] = $composicao->get_composicoes_auxiliares();
    ...
    public function lista_transporte_material_classe()
    {
    	...
    	$data['transporte_material_classe'] = $this->transporte_material_classedao->get_transporte_material_classe_by_id_transporte($id);
      
    	//load the view
    	$data['main_content'] = 'admin/transporte_material_classe/list_transporte_material_classe';
    	$this->load->view('includes/template', $data);
...
public function add()
    {
        ...
        if ($this->input->server('REQUEST_METHOD') === 'POST')
        {
            ...
            //form validation
        	//aplicar controle caso n exista nenhum valor para id_composicao
            ...
            if ($this->form_validation->run())
            {
                ...
                $data_to_store = array('id_transporte' => $this->input->post('id_transporte'),
    ...
    public function update()
    {
        //product id 
        $id = $this->uri->segment(4);
        $id_transporte = $this->uri->segment(5);
        ...
        if ($this->input->server('REQUEST_METHOD') === 'POST')
        {
            ...
            if ($this->form_validation->run())
            {
                ...
                redirect('admin/transporte_material_classe/update/'.$id.'/'.$id_transporte);
