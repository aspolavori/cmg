...
public function add()
    {
        ...
        if ($this->input->server('REQUEST_METHOD') === 'POST')
        {
        	...
        	$this->form_validation->set_rules('utilizacao_improdutivo', 'utilizacao_improdutivo', 'numeric|required'); 
    ...
    public function update()
    {
        ...
        if ($this->input->server('REQUEST_METHOD') === 'POST')
        {
        	...
        	$this->form_validation->set_rules('quantidade', 'quantidade', 'required');
        	$this->form_validation->set_rules('utilizacao_improdutivo', 'utilizacao_improdutivo', 'numeric|required');
        	$this->form_validation->set_rules('utilizacao_operativo', 'utilizacao_operativo', 'numeric|required');
        	$this->form_validation->set_rules('observacao', 'observacao', '');
            $this->form_validation->set_error_delimiters('<div class="alert alert-error"><a class="close" data-dismiss="alert">×</a><strong>', '</strong></div>');
            //if the form has passed through the validation
            if ($this->form_validation->run())
    ...
    */
    public function delete()
    {
        ...
        redirect('admin/composicao_equipamento/lista_equipamento/'.$id_composicao);
