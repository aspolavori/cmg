...
public function add()
    {
        ...
        if ($this->input->server('REQUEST_METHOD') === 'POST')
        {
        	...
        	$this->form_validation->set_rules('producao_equipe', 'producao_equipe', 'required'); 
            ...
            {
                $data_to_store = array('codigo' => $this->input->post('codigo'),'titulo' => $this->input->post('titulo'),'data_base' => $this->input->post('data_base'),'tipo' => $this->input->post('tipo'),'producao_equipe' => $this->input->post('producao_equipe'),'producao_equipe_unidade' => $this->input->post('producao_equipe_unidade'),'observacao' => $this->input->post('observacao'),
                );
