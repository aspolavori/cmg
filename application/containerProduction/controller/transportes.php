            ...
            */
            ...
            if($search_string){
                if($order){
                    ...
                    $data['transportes'] = $this->transportesdao->get_transportes($search_string, '', $order_type, $config['per_page'],$limit_end);           
                }
            }else{
                if($order){
                    $data['transportes'] = $this->transportesdao->get_transportes('', $order, $order_type, $config['per_page'],$limit_end);        
                }else{
                    $data['transportes'] = $this->transportesdao->get_transportes('', '', $order_type, $config['per_page'],$limit_end);        
                }
            }
...
public function add()
    {
        ...
        if ($this->input->server('REQUEST_METHOD') === 'POST')
        {
            ...
            {
                $data_to_store = array('titulo' => $this->input->post('titulo'),'codigo' => $this->input->post('codigo'),'regiao' => $this->input->post('regiao'),'uf' => $this->input->post('uf'),'data_base' => $this->input->post('data_base'),'observacao' => $this->input->post('observacao'),
                );
