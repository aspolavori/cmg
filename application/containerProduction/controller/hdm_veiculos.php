...
public function add()
    {
        ...
        if ($this->input->server('REQUEST_METHOD') === 'POST')
        {
        	...
        	$this->form_validation->set_rules('gasolina_fator_conversao', 'gasolina_fator_conversao', 'required'); 
        	$this->form_validation->set_rules('valor_oleo', 'valor_oleo', 'required'); 
        	$this->form_validation->set_rules('oleo_fator_conversao', 'oleo_fator_conversao', 'required'); 
            ...
            {
                $data_to_store = array('reajuste_salario' => $this->input->post('reajuste_salario'),'ind_reajuste' => $this->input->post('ind_reajuste'),'ind_var_igpm' => $this->input->post('ind_var_igpm'),'valor_gasolina' => $this->input->post('valor_gasolina'),'gasolina_fator_conversao' => $this->input->post('gasolina_fator_conversao'),'valor_oleo' => $this->input->post('valor_oleo'),'oleo_fator_conversao' => $this->input->post('oleo_fator_conversao'),'valor_gas_e' => $this->input->post('valor_gas_e'),'valor_oleo_e' => $this->input->post('valor_oleo_e'),'data_base' => $this->input->post('data_base'),'observacao' => $this->input->post('observacao'),
                );
                //if the insert has returned true then we show the flash message
                if($this->hdm_veiculosdao->store_hdm_veiculos($data_to_store)){
    ...
    public function update()
    {
        ...
        if ($this->input->server('REQUEST_METHOD') === 'POST')
        {
        	...
        	'gasolina_fator_conversao' => $this->input->post('gasolina_fator_conversao'),
        	'valor_oleo' => $this->input->post('valor_oleo'),
        	'oleo_fator_conversao' => $this->input->post('oleo_fator_conversao'),
        	...
        	'observacao' => $this->input->post('observacao'),                    
                ...
                //if the insert has returned true then we show the flash message
                if($this->hdm_veiculosdao->update_hdm_veiculos($id, $data_to_store) == TRUE){
