...
public function add()
    {
        ...
        if ($this->input->server('REQUEST_METHOD') === 'POST')
        {
            ...
            {
                $data_to_store = array('id_solucao' => $this->input->post('id_solucao'),'id_composicao' => $this->input->post('id_composicao'),'observacao' => $this->input->post('observacao'),
                );
    ...
    */
    public function delete()
    {
        ...
        redirect('admin/solucao_composicao');
    }//edit    			
    	}