...
public function add()
    {
        ...
        if ($this->input->server('REQUEST_METHOD') === 'POST')
        {
            ...
            {
                $data_to_store = array('id_composicao' => $this->input->post('id_composicao'),'id_mao_obra' => $this->input->post('id_mao_obra'),'quantidade' => $this->input->post('quantidade'),'observacao' => $this->input->post('observacao'),
                );
    ...
    */
    public function delete()
    {
        ...
        redirect('admin/composicao_mao_obra');
    }//edit    			
    	}