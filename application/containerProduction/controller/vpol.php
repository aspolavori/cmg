...
public function add()
    {
        ...
        if ($this->input->server('REQUEST_METHOD') === 'POST')
        {
            ...
            {
                $data_to_store = array('EUC_TYRE' => $this->input->post('EUC_TYRE'),'EUC_OIL' => $this->input->post('EUC_OIL'),'EUC_CARGO' => $this->input->post('EUC_CARGO'),'FUC_TYRE' => $this->input->post('FUC_TYRE'),'FUC_OIL' => $this->input->post('FUC_OIL'),
                );
    ...
    public function update()
    {
        ...
        if ($this->input->server('REQUEST_METHOD') === 'POST')
        {
            ...
            if ($this->form_validation->run())
            {
                ...
                $data_to_store = array(
        	'EUC_TYRE' => $this->input->post('EUC_TYRE'),
