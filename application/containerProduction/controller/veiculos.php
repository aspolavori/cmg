...
public function add()
    {
        ...
        if ($this->input->server('REQUEST_METHOD') === 'POST')
        {
        	...
        	$this->form_validation->set_rules('EUC_FUEL', 'EUC_FUEL', 'required'); 
        	$this->form_validation->set_rules('EUC_INTRST', 'EUC_INTRST', 'required'); 
        	$this->form_validation->set_rules('FUC_FUEL', 'FUC_FUEL', 'required'); 
    ...
    public function update()
    {
        ...
        if ($this->input->server('REQUEST_METHOD') === 'POST')
        {
        	...
        	'EUC_FUEL' => $this->input->post('EUC_FUEL'),
        	'EUC_INTRST' => $this->input->post('EUC_INTRST'),
        	'FUC_FUEL' => $this->input->post('FUC_FUEL'),
