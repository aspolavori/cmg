          ...
          <table class="table table-striped table-bordered table-condensed">
            <thead>
	          ...
	          echo '<td class="crud-actions">
                  <a href="'.site_url("admin").'/equipamentos/update/'.$row['id'].'" class="btn btn-info">Ver & editar</a>  
                  <a href="'.site_url("admin").'/equipamentos/delete/'.$row['id'].'" class="btn btn-danger">deletar</a>
                </td>';
                echo "</tr>";
              }
              ?>      
