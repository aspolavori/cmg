	      ...
	      if($this->session->flashdata('flash_message')){
	        if($this->session->flashdata('flash_message') == 'updated')
	        {
	          echo '<div class="alert alert-success">';
	            ...
	            echo '<strong>Well done!</strong> composicao_equipamento updated with success.';
	          echo '</div>';       
	        }else{
	      ...
	      ?>
		    <?php
    		  ...
    		  <?php 
		    		 ...
		    		 echo form_dropdown('id_', $options_, composicao_equipamento[0]['id_'] );	
				     echo          
				            '</div>
				          </div>';	
			  ?>
		     ...
		     <fieldset><div class="control-group">
		            ...
		            <div class="controls">
		              <input type="text" id="" name="id_composicao" value="<?php echo $composicao_equipamento[0]['id_composicao']; ?>" >
		              <!--<span class="help-inline">Woohoo!</span>-->
		            </div>
		          </div><div class="control-group">
		            <label for="inputError" class="control-label">Equipamento</label>
		            <div class="controls">
		              <input type="text" id="" name="id_equipamento" value="<?php echo $composicao_equipamento[0]['id_equipamento']; ?>" >
		              <!--<span class="help-inline">Woohoo!</span>-->
		            </div>
		          </div><div class="control-group">
		            ...
		            <div class="controls">
		              <input type="text" id="" name="utilizacao_improdutivo" value="<?php echo $composicao_equipamento[0]['utilizacao_improdutivo']; ?>" >
		              <!--<span class="help-inline">Woohoo!</span>-->
		            </div>
		          </div><div class="control-group">
		            <label for="inputError" class="control-label">Utilização Operativo</label>
		            <div class="controls">
		              <input type="text" id="" name="utilizacao_operativo" value="<?php echo $composicao_equipamento[0]['utilizacao_operativo']; ?>" >
		              <!--<span class="help-inline">Woohoo!</span>-->
		            </div>
		          </div><div class="control-group">
