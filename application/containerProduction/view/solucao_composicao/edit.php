	      ...
	      ?>
		    <?php
    		  ...
    		  <?php 
		    		 ...
		    		 echo form_dropdown('id_', $options_, solucao_composicao[0]['id_'] );	
				     echo          
				            '</div>
				          </div>';	
			  ?>
		     ...
		     <fieldset><div class="control-group">
		            ...
		            <div class="controls">
		              <input type="text" id="" name="id_solucao" value="<?php echo $solucao_composicao[0]['id_solucao']; ?>" >
		              <!--<span class="help-inline">Woohoo!</span>-->
		            </div>
		          </div><div class="control-group">
		            <label for="inputError" class="control-label">Composição</label>
		            <div class="controls">
		              <input type="text" id="" name="id_composicao" value="<?php echo $solucao_composicao[0]['id_composicao']; ?>" >
		              <!--<span class="help-inline">Woohoo!</span>-->
		            </div>
		          </div><div class="control-group">
