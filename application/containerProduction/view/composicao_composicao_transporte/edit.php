	      ...
	      if($this->session->flashdata('flash_message')){
	        if($this->session->flashdata('flash_message') == 'updated')
	        {
	          echo '<div class="alert alert-success">';
	            ...
	            echo '<strong>Well done!</strong> composicao_composicao_transporte updated with success.';
	          echo '</div>';       
	        }else{
	      ...
	      ?>
		    <?php
    		  ...
    		  <?php 
		    		 ...
		    		 echo form_dropdown('id_', $options_, composicao_composicao_transporte[0]['id_'] );	
				     echo          
				            '</div>
				          </div>';	
			  ?>
		     ...
		     <fieldset><div class="control-group">
		            ...
		            <div class="controls">
		              <input type="text" id="" name="id_composicao" value="<?php echo $composicao_composicao_transporte[0]['id_composicao']; ?>" >
		              <!--<span class="help-inline">Woohoo!</span>-->
		            </div>
		          </div><div class="control-group">
		            <label for="inputError" class="control-label">Composição Transporte</label>
		            <div class="controls">
		              <input type="text" id="" name="id_composicao_transporte" value="<?php echo $composicao_composicao_transporte[0]['id_composicao_transporte']; ?>" >
		              <!--<span class="help-inline">Woohoo!</span>-->
		            </div>
		          </div><div class="control-group">
		            <label for="inputError" class="control-label">Quantideda</label>
		            <div class="controls">
