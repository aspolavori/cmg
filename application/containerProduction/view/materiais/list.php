	  ...
	  <div class="row">
        <div class="span12 columns">
          <div class="well">
            ...
            foreach ($materiais as $array) {
              foreach ($array as $key => $value) {
                $options_materiais[$key] = $key;
              }
              break;
            }

            echo form_open("admin/materiais", $attributes);
     
              echo form_label("Search:", "search_string");
              echo form_input("search_string", $search_string_selected);

              echo form_label("Order by:", "order");
              echo form_dropdown("order", $options_materiais, $order, 'class="span2"');
          ...
          <table class="table table-striped table-bordered table-condensed">
            <thead>
	          ...
	          echo '<td class="crud-actions">
                  <a href="'.site_url("admin").'/materiais/update/'.$row['id'].'" class="btn btn-info">Ver & editar</a>  
                  <a href="'.site_url("admin").'/materiais/delete/'.$row['id'].'" class="btn btn-danger">deletar</a>
                </td>';
                echo "</tr>";
              }
              ?>      
