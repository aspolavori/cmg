	      ...
	      if(isset($flash_message)){
	        if($flash_message == TRUE)
	        {
	          echo '<div class="alert alert-success">';
	            ...
	            echo '<strong>Well done!</strong> new composicao_composicao created with success.';
	          echo '</div>';       
	        }else{
	      ...
	      ?> 
		    <?php
			  ...
			  */
		      ...
		      echo form_open("admin/composicao_composicao/add", $attributes);
		     ?>
		     <fieldset><div class="control-group">
		            ...
		            <div class="controls">
		              <input type="text" id="" name="id_composicao2" value="<?php echo set_value('id_composicao2'); ?>" >
		              <!--<span class="help-inline">Woohoo!</span>-->
		            </div>
		          </div><div class="control-group">
