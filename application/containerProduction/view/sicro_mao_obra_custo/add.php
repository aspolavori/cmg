	      ...
	      ?> 
		    <?php
		     ...
		     <fieldset><div class="control-group">
		            ...
		            <div class="controls">
		              <input type="text" id="" name="regiao" value="<?php echo set_value('regiao'); ?>" >
		              <!--<span class="help-inline">Woohoo!</span>-->
		            </div>
		          </div><div class="control-group">
		            ...
		            <div class="controls">
		              <input type="text" id="" name="cidade" value="<?php echo set_value('cidade'); ?>" >
		              <!--<span class="help-inline">Woohoo!</span>-->
		            </div>
		          </div><div class="control-group">
		            <label for="inputError" class="control-label">Data Base</label>
		            <div class="controls">
		              <input type="text" id="" name="data_base" value="<?php echo set_value('data_base'); ?>" >
		              <!--<span class="help-inline">Woohoo!</span>-->
		            </div>
		          </div>
