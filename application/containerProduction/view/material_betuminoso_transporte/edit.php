	      ...
	      ?>
		    <?php
    		  ...
    		  <?php 
		    		 ...
		    		 echo form_dropdown('id_', $options_, material_betuminoso_transporte[0]['id_'] );	
				     echo          
				            '</div>
				          </div>';	
			  ?>
		     ...
		     <fieldset><div class="control-group">
		            ...
		            <div class="controls">
		              <input type="text" id="" name="id_material_betuminoso" value="<?php echo $material_betuminoso_transporte[0]['id_material_betuminoso']; ?>" >
		              <!--<span class="help-inline">Woohoo!</span>-->
		            </div>
		          </div><div class="control-group">
		            <label for="inputError" class="control-label">transporte 1</label>
		            <div class="controls">
		              <input type="text" id="" name="id_transporte_material_classe1" value="<?php echo $material_betuminoso_transporte[0]['id_transporte_material_classe1']; ?>" >
		              <!--<span class="help-inline">Woohoo!</span>-->
		            </div>
		          </div><div class="control-group">
		            <label for="inputError" class="control-label">transporte 2</label>
		            <div class="controls">
		              <input type="text" id="" name="id_transporte_material_classe2" value="<?php echo $material_betuminoso_transporte[0]['id_transporte_material_classe2']; ?>" >
		              <!--<span class="help-inline">Woohoo!</span>-->
		            </div>
		          </div><div class="control-group">
