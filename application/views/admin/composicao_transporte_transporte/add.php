    <div class="container top">
	      ...
	      <div class="page-header">
	        <h2>
	          Adicionar <?php echo ucfirst('Composição Transporte');?>
	        </h2>
	      </div> 
	      <?php
	      //flash messages
	      if(isset($flash_message)){
	        if($flash_message == TRUE)
	        {
	          echo '<div class="alert alert-success">';
	            ...
	            echo '<strong>Well done!</strong> new composicao_transporte_transporte created with success.';
	          echo '</div>';       
	        }else{
	      ...
	      ?> 
		    <?php
			  ...
			  */
		      ...
		      echo form_open("admin/composicao_transporte_transporte/add", $attributes);
		     ?>
		     <fieldset>
		     	  <?php
		         echo '<div class="control-group">';
			        ...
			        echo '<div class="controls">';
			        	echo form_dropdown('id_composicao_transporte', $options_composicao_transporte, set_value('id_composicao_transporte'), 'class="span2" style="width: 600px"');
			        echo '</div>';
		         echo '</div>';
