    <div class="container top">
	      <ul class="breadcrumb">
	        ...
	        <li>
	          <a href="<?php echo site_url("admin").'/sicro_material_betuminoso_custo/lista_material_betuminoso/'.$id_sicro; ?>">
	      ...
	      if(isset($flash_message_not_exist)){
	      	echo '<div class="alert alert-error">';
	      	echo '<a class="close" data-dismiss="alert">×</a>';
	      	echo 'O registro de material betuminoso <strong>'.$flash_message_not_exist.'</strong> não existe no cadastro de materiais betuminosos. Cadastro-o primeiro e tente o upload novamente.';
	      	echo '</div>';
	      }
		      ?> 
		    <?php
			 ...
			 //form validation
		      ...
		      echo form_open("admin/sicro_material_betuminoso_custo/add/".$id_sicro, $attributes);
		     ?>
		     <fieldset>
		     <div id="formulario"  >
		         ...
		         echo '<div class="control-group">';
		          echo '<label for="inputError" class="control-label">Material Betuminoso</label>';
		          echo '<div class="controls">';
			          if( isset($id_material_betuminoso)){
			          	echo form_dropdown('id_material_betuminoso', $options_materiais_betuminosos, $id_material_betuminoso, 'style="width: 390px;"');
			          }else{
