    <div class="container top">
	      ...
	      <div class="page-header">
	        <h2>
	          Adicionar <?php echo ucfirst('Classe de Veículo');?>
	        </h2>
	      </div> 
	      <?php
	      //flash messages
	      if(isset($flash_message)){
	        if($flash_message == TRUE)
	        {
	          echo '<div class="alert alert-success">';
	            ...
	            echo '<strong>Well done!</strong> new classeveiculo created with success.';
	          echo '</div>';       
	        }else{
	      ...
	      ?> 
		    <?php
		      ...
		      echo form_open("admin/classeveiculos/add", $attributes);
		     ?>
