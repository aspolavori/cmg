    <div class="container top">
	      <ul class="breadcrumb">
	        ...
	        <li>
	          <a href="<?php echo site_url("admin").'/'.$this->uri->segment(2).'/sondagem/'.$id_sondagens; ?>">
	      ...
	      if(isset($flash_message)){
	        if($flash_message == TRUE)
	        {
	          echo '<div class="alert alert-success">';
	            ...
	            echo '<strong>Well done!</strong> new sondagem_file created with success.';
	          echo '</div>';       
	        }else{
	      ...
	      ?> 
		    <?php
			  ...
			  */
		      ...
		      echo form_open("admin/sondagem_files/add/".$id_sondagens, $attributes);
		     ?>
		     <fieldset>
		          <input type="hidden" id="" name="id_sondagens" value="<?php echo $id_sondagens ?>" >
