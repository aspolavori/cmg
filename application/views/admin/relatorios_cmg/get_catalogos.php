	  ...
	  <div class="row">
        <div class="span12 columns">
          <div class="well">
            ...
            echo form_open("admin/relatorios_cmg/catalogos", $attributes);
          ...
          <table class="table table-striped table-bordered table-condensed">
            <thead>
	          ...
	          echo '<td class="crud-actions">
              	  <a href="'.site_url("admin").'/relatorios_cmg/gerar_catalogo/'.$row['id'].'" class="btn btn-info" style="width: 120px" >Escolher Célula</a>
                </td>';
                echo "</tr>";
              }
              ?>      
