<div class="container top">
	      <ul class="breadcrumb">
	        ...
	        <li>
	          <a href="<?php echo site_url("admin").'/composicao_composicao_transporte/lista_composicao_transporte/'.$id_composicao; ?>">
	            Trasnporte
	          </a> 
	          <span class="divider">/</span>
	        </li>
	      ...
	      <div class="page-header">
	        <h2>
	          Adicionar Composição Transporte
	        </h2>
	      </div> 
	      <?php
	      //flash messages
	      ...
	      if(isset($flash_message)){
	        if($flash_message == TRUE)
	        {
	          echo '<div class="alert alert-success">';
	            ...
	            echo '<strong>Well done!</strong> new composicao transporte created with success.';
	          echo '</div>';       
	        }else{
			  $span = false;
	      ...
	      ?> 
		    <?php
			  ...
			  */
		      ...
		      echo form_open("admin/composicao_composicao_transporte/add/".$id_composicao, $attributes);
		     ?>
		     <fieldset>
		          <input type="hidden" id="" name="id_composicao" value="<?php echo $id_composicao; ?>" >
		          <?php
		         echo '<div class="control-group">';
		          echo '<label for="inputError" class="control-label">Composição Transporte</label>';
		          echo '<div class="controls">';			          
		          	echo form_dropdown('id_composicao_transporte', $options_composicao_transporte, set_value('id_composicao_transporte'), 'style="width: 390px;"');			          
		          echo '</div>';
	          	 echo '</div>';
	          	 ?>
