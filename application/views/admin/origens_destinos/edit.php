	      ...
	      ?>
		    <?php
    		  ...
    		  */
		      ...
		      echo form_open("admin/origens_destinos/update/".$this->uri->segment(4), $attributes);
		     ?>
		     <fieldset><div class="control-group">
		            <label for="inputError" class="control-label">id_pesquisa</label>
		            <div class="controls">
		              <input type="text" id="" name="id_pesquisa" value="<?php echo $origem_destino[0]['id_pesquisa']; ?>" >
		              <!--<span class="help-inline">Woohoo!</span>-->
		            </div>
		          </div><div class="control-group">
		            <label for="inputError" class="control-label">Sentido</label>
		            <div class="controls">
		              <input type="text" id="" name="id_sentido" value="<?php echo $origem_destino[0]['id_sentido']; ?>" >
		              <!--<span class="help-inline">Woohoo!</span>-->
		            </div>
		          </div><div class="control-group">
		            <label for="inputError" class="control-label">Veículo</label>
		            <div class="controls">
		              <input type="text" id="" name="id_veiculo" value="<?php echo $origem_destino[0]['id_veiculo']; ?>" >
		              <!--<span class="help-inline">Woohoo!</span>-->
		            </div>
		          </div><div class="control-group">
