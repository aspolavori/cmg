        ...
        <div class="span12 columns">
          ...
          <table class="table table-striped table-bordered table-condensed">
            <thead>
              <tr>
            	<th class="header">#</th>
				<th class="yellow header headerSortDown">id_pesquisa</th>
	            ...
	            <tbody>
	              ...
	              foreach($origens_destinos as $row)
	              {
	                echo '<tr>';
	                echo '<td>'.$row['id'].'</td>';
					echo '<td>'.$row['id_pesquisa'].'</td>';
					echo '<td>'.$row['id_sentido'].'</td>';
	          ...
	          echo '<td class="crud-actions">
                  <a href="'.site_url("admin").'/origens_destinos/update/'.$row['id'].'" class="btn btn-info">Ver & editar</a>  
                  <a href="'.site_url("admin").'/origens_destinos/delete/'.$row['id'].'" class="btn btn-danger">deletar</a>
                </td>';
                echo "</tr>";
              }
              ?>      
