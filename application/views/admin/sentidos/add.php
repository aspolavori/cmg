	      ...
	      if(isset($flash_message)){
	        if($flash_message == TRUE)
	        {
	          echo '<div class="alert alert-success">';
	            ...
	            echo '<strong>Well done!</strong> new sentido created with success.';
	          echo '</div>';       
	        }else{
	      ...
	      ?> 
		    <?php
			  ...
			  */
		      ...
		      echo form_open("admin/sentidos/add", $attributes);
		     ?>
		     <fieldset><div class="control-group">
		            <label for="inputError" class="control-label">Pesquisa Tráfego</label>
		            <div class="controls">
		              <input type="text" id="" name="id_pesquisa_trafegos" value="<?php echo set_value('id_pesquisa_trafegos'); ?>" >
		            ...
		            <div class="controls">
		              <input type="text" id="" name="label_origem" value="<?php echo set_value('label_origem'); ?>" >
		              <!--<span class="help-inline">Woohoo!</span>-->
		            </div>
		          </div><div class="control-group">
		            ...
		            <div class="controls">
		              <input type="text" id="" name="label_destino" value="<?php echo set_value('label_destino'); ?>" >
		              <!--<span class="help-inline">Woohoo!</span>-->
		            </div>
		          </div>
