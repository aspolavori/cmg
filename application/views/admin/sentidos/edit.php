	      ...
	      ?>
		    <?php
    		  ...
    		  */
		      ...
		      echo form_open("admin/sentidos/update/".$this->uri->segment(4), $attributes);
		     ?>
		     <fieldset><div class="control-group">
		            <label for="inputError" class="control-label">Pesquisa Tráfego</label>
		            <div class="controls">
		              <input type="text" id="" name="id_pesquisa_trafegos" value="<?php echo $sentido[0]['id_pesquisa_trafegos']; ?>" >
