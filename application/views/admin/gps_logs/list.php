	  ...
	  <div class="row">
        <div class="span12 columns">
          <div class="well">
            ...
            $options_gps_logs = array();    
            foreach ($gps_logs as $array) {
              foreach ($array as $key => $value) {
                $options_gps_logs[$key] = $key;
              }
              break;
            }

            echo form_open("admin/gps_logs", $attributes);
     
              echo form_label("Search:", "search_string");
              echo form_input("search_string", $search_string_selected);

              echo form_label("Order by:", "order");
              echo form_dropdown("order", $options_gps_logs, $order, 'class="span2"');
          ...
          <table class="table table-striped table-bordered table-condensed">
            <thead>
	          ...
	          echo '<td class="crud-actions">
                  <a href="'.site_url("admin").'/gps_logs/update/'.$row['ID_LOG'].'" class="btn btn-info">view & edit</a>  
                  <a href="'.site_url("admin").'/gps_logs/delete/'.$row['ID_LOG'].'" class="btn btn-danger">delete</a>
                </td>';
                echo "</tr>";
              }
              ?>      
