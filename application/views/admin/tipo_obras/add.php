    <div class="container top">
	      ...
	      if(isset($flash_message)){
	        if($flash_message == TRUE)
	        {
	          echo '<div class="alert alert-success">';
	            ...
	            echo '<strong>Well done!</strong> new tipo_obra created with success.';
	          echo '</div>';       
	        }else{
	      ...
	      ?> 
		    <?php
		      ...
		      echo form_open("admin/tipo_obras/add", $attributes);
		     ?>
		     <fieldset><div class="control-group">
		            ...
		            <div class="controls">
		            <?php
		            echo form_dropdown('unidade', array( 1 => 'Característica da Rodovia', 2 => 'Tipo de Obra', 3 => 'Local da Intervenção'), set_value('id_classe_obras') );
		            ?>
		              <!--<span class="help-inline">Woohoo!</span>-->
		            </div>
		          </div>
