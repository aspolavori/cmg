    <div class="container top">
	      ...
	      <div class="page-header users-header">
    		<h2>
              Lista de Arquivos
              <a onclick="return popitup('<?php echo site_url("admin").'/sondagem_files/sondagem/'.$id_sondagem; ?>')"  
              href="" class="btn btn-success" target="_blank">Ver Lista</a>
            </h2>
          </div>      
	  <div class="row">
          ...
          <table class="table table-striped table-bordered table-condensed">
            <thead>
              ...
              <tr>
              	...
              	<th colspan="1" >ENSAIO TRIAXIAL</th>
              </tr>
              <tr>
            	<th class="header">#</th>
				...
				<th class="yellow header headerSortDown">Ensaios Adicionais</th>
	            ...
	            <tbody>
	              ...
	              foreach($resumo_sondagens as $row)
	              {
					...
					echo '<td>';
					?>
						<a onclick="return popitup('<?php echo site_url("admin").'/resumo_sondagem_files/resumo/'.$row['id']; ?>')"  
              				href="" class="btn btn-success" target="_blank">Ver</a>
						</td>';
					<?php
                echo "</tr>";
              }
