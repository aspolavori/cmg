	  ...
	  <div class="row">
        <div class="span12 columns">
          <div class="well">
            ...
            echo form_open("admin/resumo_sondagens", $attributes);
     
              echo form_label("Search:", "search_string");
              echo form_input("search_string", $search_string_selected);

              echo form_label("Order by:", "order");
              echo form_dropdown("order", $options_resumo_sondagens, $order, 'class="span2"');
          ...
          <table class="table table-striped table-bordered table-condensed">
            <thead>
              <tr>
            	<th class="header">#</th>
				<th class="yellow header headerSortDown">Sondagem</th>
				...
				<th class="yellow header headerSortDown">Densidade Natural</th>
				<th class="yellow header headerSortDown">Wcampo</th>
				<th class="yellow header headerSortDown">Areia</th>
				<th class="yellow header headerSortDown">Nível de Água</th>
