<div class="container top">
	      <ul class="breadcrumb">
	        ...
	        <li>
	          <a href="<?php echo site_url("admin").'/composicao_material/lista_material/'.$id_composicao; ?>">
	            Materiais
	          </a> 
	          <span class="divider">/</span>
	        </li>
	      ...
	      <div class="page-header">
	        <h2>
	          Adicionar <?php echo ucfirst('Material');?>
	        </h2>
	      </div> 
	      <?php
	      //flash messages
	      ...
	      if(isset($flash_message)){
	        if($flash_message == TRUE)
	        {
	          echo '<div class="alert alert-success">';
	            ...
	            echo '<strong>Well done!</strong> new composicao_material created with success.';
	          echo '</div>';       
	        }else{
			  $span = false;
	      ...
	      ?> 
		    <?php
			  ...
			  */
		      ...
		      echo form_open("admin/composicao_material/add/".$id_composicao, $attributes);
		     ?>
		     <fieldset>
