	      ...
	      if(isset($flash_message)){
	        if($flash_message == TRUE)
	        {
	          echo '<div class="alert alert-success">';
	            ...
	            echo '<strong>Well done!</strong> new composicao_variaveis created with success.';
	          echo '</div>';       
	        }else{
	      ...
	      ?> 
		    <?php
			  ...
			  */
		      ...
		      echo form_open("admin/composicao_variaveis/add", $attributes);
		     ?>
		     <fieldset><div class="control-group">
		            ...
		            <div class="controls">
		              <input type="text" id="" name="id_variaveis" value="<?php echo set_value('id_variaveis'); ?>" >
		              <!--<span class="help-inline">Woohoo!</span>-->
		            </div>
		          </div><div class="control-group">
