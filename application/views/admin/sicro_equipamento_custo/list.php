	  ...
	  <div class="row">
        <div class="span12 columns">
          <div class="well">
            ...
            $options_sicro_equipamento_custo = array();    
            foreach ($sicro_equipamento_custo as $array) {
              foreach ($array as $key => $value) {
                $options_sicro_equipamento_custo[$key] = $key;
              }
              break;
            }

            echo form_open("admin/sicro_equipamento_custo", $attributes);
     
              echo form_label("Search:", "search_string");
              echo form_input("search_string", $search_string_selected);

              echo form_label("Order by:", "order");
              echo form_dropdown("order", $options_sicro_equipamento_custo, $order, 'class="span2"');
          ...
          <table class="table table-striped table-bordered table-condensed">
            <thead>
	          ...
	          echo '<td class="crud-actions">
                  ...
                  <a href="'.site_url("admin").'/sicro_equipamento_custo/delete/'.$row['id'].'" class="btn btn-danger">deletar</a>
                </td>';
                echo "</tr>";
              }
              ?>      
