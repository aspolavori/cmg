    <div class="container top">
	      ...
	      <div class="page-header users-header">
    		<h2>
              <?php echo 'Composicao Materiais Betuminosos';?>
          ...
          <table class="table table-striped table-bordered table-condensed">
            <thead>
	          ...
	          echo '<td class="crud-actions">
                  ...
                  <a href="'.site_url("admin").'/composicao_material_betuminoso/delete/'.$row['id'].'/'.$id_composicao.'" class="btn btn-danger">deletar</a>
                </td>';
                echo "</tr>";
              }
              ?>      
