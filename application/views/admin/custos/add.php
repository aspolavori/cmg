    <div class="container top">
	      ...
	      if(isset($flash_message)){
	        if($flash_message == TRUE)
	        {
	          echo '<div class="alert alert-success">';
	            ...
	            echo '<strong>Well done!</strong> new custo created with success.';
	          echo '</div>';       
	        }else{
	      ...
	      ?> 
		    <?php
		      ...
		      echo form_open("admin/custos/add", $attributes);
		     ?>
		     <fieldset><div class="control-group">
		            <label for="inputError" class="control-label">Custo de Ilesos</label>
		            <div class="controls">
		              <input type="text" id="" name="ilesos" value="<?php echo set_value('ilesos'); ?>" >
		            ...
		            <div class="controls">
		              <input type="text" id="" name="geral" value="<?php echo set_value('geral'); ?>" >
		              <!--<span class="help-inline">Woohoo!</span>-->
		            </div>
		          </div><div class="control-group">
