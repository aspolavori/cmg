        ...
        <div class="span12 columns">
          ...
          <table class="table table-striped table-bordered table-condensed">
            <thead>
              <tr>
            	<th class="header">#</th>
				<th class="yellow header headerSortDown">Pesquisa Tráfego</th>
	          ...
	          echo '<td class="crud-actions">
                  <a href="'.site_url("admin").'/contagens/update/'.$row['id'].'" class="btn btn-info">Ver & editar</a>  
                  <a href="'.site_url("admin").'/contagens/delete/'.$row['id'].'" class="btn btn-danger">deletar</a>
                </td>';
                echo "</tr>";
              }
              ?>      
