    <div class="container top">
	      ...
	      <div class="page-header users-header">
    		<h2>
              Obra Futura
              <a  href="<?php echo site_url("admin").'/'.$this->uri->segment(2); ?>/add_obra_futura" class="btn btn-success">Adicionar Novo</a>
            </h2>
          </div>
	  <div class="row">
          ...
          <table class="table table-striped table-bordered table-condensed">
            <thead>
	          ...
	          echo '<td class="crud-actions">
                  <a href="'.site_url("admin").'/obras/update_obra_futura/'.$row['id'].'" class="btn btn-info">Ver & editar</a>  
                  <a href="'.site_url("admin").'/obras/delete_obra_futura/'.$row['id'].'" class="btn btn-danger">deletar</a>
                </td>';
                echo "</tr>";
              }
              ?>      
