    <div class="container top">
	      ...
	      <div class="page-header">
	        <h2>
	          Editando <?php echo ucfirst($this->uri->segment(2));?>
	        </h2>
	      </div>
	     <?php
	      //flash messages
	      ...
	      ?>
		    <?php
		      ...
		      echo form_open("admin/obras/update/".$this->uri->segment(4), $attributes);
		     ?>
		     <fieldset>
		     <?php 
		     echo 
            ...
            echo '<div class="controls">';
              echo form_multiselect('tipos[]', $options_tipos, $selected_tipo, 'style="width: 500px; height:400px;"');
            echo '</div>';
          	echo '</div>';
		     ?>
		     	<div class="control-group">
		          ...
		          <div class="control-group">
		            <label for="inputError" class="control-label">Projeto</label>
		            <div class="controls">
		              <input type="text" id="" name="projeto" value="<?php echo $obra[0]['projeto']; ?>" >
		              <!--<span class="help-inline">Woohoo!</span>-->
		            </div>
		          </div>
		          <div class="control-group">
