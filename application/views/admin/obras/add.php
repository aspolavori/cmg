    <div class="container top">
	      ...
	      <div class="page-header">
	        <h2>
	          Adicionando <?php echo ucfirst($this->uri->segment(2));?>
	        </h2>
	      </div> 
	      <?php
	      //flash messages
	      ...
	      ?> 
		    <?php
		      ...
		      */
		      ...
		      echo form_open("admin/obras/add", $attributes);
		     ?>
		     <fieldset>
		     <?php 
		     echo 
		     ...
		     echo '<div class="control-group">';
			     ...
			     echo '<div class="controls">';
			     	echo form_multiselect('tipos[]', $options_tipos, set_value('tipos'), 'style="width: 500px; height:400px;"');
		     ...
		     ?>
		          ...
		          <div class="control-group">
		            ...
		            <div class="controls">
		              <input type="text" id="" name="projeto" value="<?php echo set_value('projeto'); ?>" >
		              <!--<span class="help-inline">Woohoo!</span>-->
		            </div>
		          </div>
		           <div class="control-group">
