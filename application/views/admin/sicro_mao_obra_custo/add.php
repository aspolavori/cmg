    <div class="container top">
	      <ul class="breadcrumb">
	        ...
	        <li>
	          <a href="<?php echo site_url("admin").'/sicro_mao_obra_custo/lista_mao_obra/'.$id_sicro; ?>">
	            Mão de Obra
	          </a> 
	          <span class="divider">/</span>
	        </li>
	      ...
	      if(isset($flash_message_not_exist)){
		    ...
		    <?php
			 ...
			 //form validation
		      ...
		      echo form_open("admin/sicro_mao_obra_custo/add/".$id_sicro, $attributes);
		     ?>
		     <fieldset>
		     <div id="formulario" style="display: none;" >
		         ...
		         echo '<div class="control-group">';
		          ...
		          echo '<div class="controls">';
			          if( isset($id_mao_obra)){
			          	echo form_dropdown('id_mao_obra', $options_mao_obra, $id_mao_obra, 'style="width: 390px;"');
			          }else{
		          ...
		          <div class="control-group">
		            ...
		            <div class="controls">
		              <input type="text" id="" name="custo_horario" style="width: 380px;" value="<?php echo set_value('custo_horario'); ?>" >
		              <?php
		              	if($span){
