	      ...
	      if(isset($flash_message)){
	        if($flash_message == TRUE)
	        {
	          echo '<div class="alert alert-success">';
	            ...
	            echo '<strong>Well done!</strong> new consulta_contagem created with success.';
	          echo '</div>';       
	        }else{
	      ...
	      ?> 
		    <?php
			  ...
			  */
		      ...
		      echo form_open("admin/consulta_contagens/add", $attributes);
		     ?>
		     <fieldset><div class="control-group">
		            ...
		            <label for="inputError" class="control-label">km_ini</label>
		            <div class="controls">
		              <input type="text" id="" name="km_ini" value="<?php echo set_value('km_ini'); ?>" >
		              <!--<span class="help-inline">Woohoo!</span>-->
		            </div>
		          </div><div class="control-group">
		            <label for="inputError" class="control-label">km_fim</label>
		            <div class="controls">
		              <input type="text" id="" name="km_fim" value="<?php echo set_value('km_fim'); ?>" >
		              <!--<span class="help-inline">Woohoo!</span>-->
		            </div>
		          </div><div class="control-group">
		            <label for="inputError" class="control-label">data_ini</label>
		            <div class="controls">
		              <input type="text" id="" name="data_ini" value="<?php echo set_value('data_ini'); ?>" >
		              <!--<span class="help-inline">Woohoo!</span>-->
		            </div>
		          </div><div class="control-group">
		            <label for="inputError" class="control-label">data_fim</label>
		            <div class="controls">
		              <input type="text" id="" name="data_fim" value="<?php echo set_value('data_fim'); ?>" >
		              <!--<span class="help-inline">Woohoo!</span>-->
		            </div>
		          </div>
