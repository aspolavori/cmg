...
const VIEW_FOLDER = 'admin/fator_pavimentacao_padrao';
	    ...
	    */
	    ...
	    public function get_fator_pavimentacao_padrao_sicro($search_string=null, $order=null, $order_type='Asc', $limit_start=null, $limit_end=null)
	    {
	    	...
	    	if($order){
	    		...
	    		$this->db->order_by('id_categoria', $order_type);
	    	}
